...
public class RPChatHelpCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GREEN + "/rp" + ChatColor.GRAY + " - Toggle RP chat mode");
        sender.sendMessage(ChatColor.GREEN + "/ooc" + ChatColor.GRAY + " - Switch to global OOC chat");
        sender.sendMessage(ChatColor.GREEN + "/whisper <msg>" + ChatColor.GRAY + " - Whisper to nearby players");
        sender.sendMessage(ChatColor.GREEN + "/yell <msg>" + ChatColor.GRAY + " - Yell to farther players");
        sender.sendMessage(ChatColor.GREEN + "/looc <msg>" + ChatColor.GRAY + " - Local OOC message");
        sender.sendMessage(ChatColor.GREEN + "/me <emote>" + ChatColor.GRAY + " - Send an emote/action");
